...
public class GiveNewRoleToUserCommand : IRequest<Result<User, UserException>>
{
    public required Guid UserId { get; init; }
    public required Guid RoleId { get; init; }
}

public class GiveNewRoleToUserCommandHandler(IUserRepository repository, IRoleRepository roleRepository)
    : IRequestHandler<GiveNewRoleToUserCommand, Result<User, UserException>>
{
    public async Task<Result<User, UserException>> Handle(GiveNewRoleToUserCommand request,
